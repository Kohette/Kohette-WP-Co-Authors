<?php
/*
Module Name: Bulk Actions creator module.
Module ID: bulk-actions-creator
Module Description: Classes to add bulk actions to admin tables
Module Required:
...
/**
* This class helps to create bulk option in Wordpress tables
*
* @package Kohette Framework
*/
class KTT_bulk_action {
    ...
    public $action;
      ...
      $this->action = $func;
        ...
        $sendback = esc_url(home_url("/")) . $sendback;

				?><script> window.location = '<?php echo $sendback;?>'; </script><?php
